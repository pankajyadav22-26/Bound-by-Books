...
import { FaLanguage, FaHeart, FaShoppingCart } from "react-icons/fa";
    ...
    <>
      {data && (
        <div className="px-4 md:px-12 py-8 bg-zinc-900 flex flex-col md:flex-row gap-8">
          <div className="bg-zinc-800 rounded p-4 h-[70vh] lg:h-[88vh] w-full lg:w-3/6 flex items-center justify-center gap-8">
            <img
              src={data.url}
              alt="Book cover"
            ...
            {isLoggedIn === true && role === "user" && (
              <div className="flex md:flex-col">
                ...
                <button
                  className="bg-white rounded-full text-3xl p-2 mt-4 text-blue-500"
                  onClick={handleCart}
                >
                  <FaShoppingCart />
                </button>
            ...
            {isLoggedIn === true && role === "admin" && (
              <div className="flex md:flex-col">
                ...
                <button
                  className="bg-white rounded-full text-3xl p-2 mt-4 text-red-500"
                  onClick={deleteBook}
                >
                  <MdDeleteOutline />
                </button>
